...
(function() {
  ...
  String_da99 = (function() {
    ...
    String_da99.prototype.regexp = function(name) {
      var val;
      val = this.constructor[name];
      if (!val) {
    ...
    String_da99.prototype.whitespace_split = function() {
      return this.strip().split(this.regexp('WHITESPACE'));
    };
